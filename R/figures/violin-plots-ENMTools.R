## ---------------------------
##
## Script name: violin-plots-ENMTools.R
##
## Purpose of script: plot ENMTools results
##
...
p2 <- data %>%
  ...
  geom_violin() +
  scale_fill_met_d(name = "Hiroshige", alpha=1) +
  labs(x = "Interval", y = "Hellinger's I") +
  theme(panel.background = element_blank(),
        plot.margin = margin(0.5,0.5,0.5,0.5, "cm"),
        panel.grid.minor.y = element_line(colour = "grey90"),
        panel.grid.minor.x = element_line(colour = "grey90"),
...
p3 <- data %>%
  ...
  geom_violin() +
  scale_fill_met_d(name = "Hiroshige", alpha=1) +
  labs(x = "Interval", y = "Spearman's Rho") +
  theme(panel.background = element_blank(),
        plot.margin = margin(0.5,0.5,0.5,0.5, "cm"),
        panel.grid.minor.y = element_line(colour = "grey90"),
        panel.grid.minor.x = element_line(colour = "grey90"),
...
ggsave("./figures/ENMTools_violin.png", height = 200, width = 70, units = "mm", dpi = 600, scale = 1.6)
