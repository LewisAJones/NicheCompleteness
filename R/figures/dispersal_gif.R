...
#dispersal types
good <- sample(x = seq(0, good_disp, 1), size = burn_in, replace = TRUE, prob = exp(-3 * seq(0, good_disp, 1)))
poor <- sample(x = seq(0, poor_disp, 1), size = burn_in, replace = TRUE, prob = exp(-4 * seq(0, poor_disp, 1)))
